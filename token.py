...
logo = ("""
🔥                          \033[1;36m𓆰𓃮𓆪                         🔥            
\033[1;36m.s5SSSs.  .s5 s.  .s    s.  .s5SSSs.  .s    s.  
\033[1;36m      SS.     SS.       SS.       SS.       SS. 
\033[1;36msS    S%S ssS SSS sS    S%S sS    `:; sS    S%S 
\033[1;36mSS    S%S SSS SSS SS    S%S SS        SS    S%S 
\033[1;36mSSSs. S%S  SSSSS  SS    S%S `:;;;;.   SSSs. S%S 
\033[1;36mSS    S%S   SSS   SS    S%S       ;;. SS    S%S 
\033[1;36mSS    `:;   `:;   SS    `:;       `:; SS    `:; 
\033[1;36mSS    ;,.   ;,.   SS    ;,. .,;   ;,. SS    ;,. 
\033[1;36m:;    ;:'   ;:'   `:;;;;;:' `:;;;;;:' :;    ;:' 
\033[38;5;208m==============================================================
\033[1;37m[*] OWNER      : \033[1;36mXMARTY AYUSH KING
\033[1;37m[*] GITHUB     : \033[1;36mXMARTY AYUSH KING42
\033[1;37m[*] STATUS     : \033[1;91mPERMIUM
\033[1;37m[*] TEAM       : AK BRAND ZONE
\033[1;37m[*] TOOL       : COOKIE + TOKEN GENRATOR
\033[38;5;208m==============================================================""")
def input_cookie():
    print(logo)
    cookie = input('%s input Cookie : %s'%(P,J))
